...
# Chatbox Facebook Chat API Remake
...
## Install
If you just want to use xaoai-chatbox, you should use this command:
```bash
npm install xaoai-chatbox
```
It will download `xaoai-chatbox` from NPM repositories
...
## Example Usage
```javascript
const login = require("xaoai-chatbox");
